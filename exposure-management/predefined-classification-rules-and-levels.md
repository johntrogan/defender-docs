...
| Azure Key Vault with high number of operations              | Cloud resource | High                      | This rule identifies Azure Key Vaults with high operation volumes, marking them as critical. It targets Key Vaults in the top 5th percentile of operations across the tenant and those with the highest operation frequency within their subscription. These metrics highlight Key Vaults essential for security and operational stability. |
